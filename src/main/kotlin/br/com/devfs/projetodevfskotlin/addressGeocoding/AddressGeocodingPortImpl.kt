...
class AddressGeocodingPortImpl(
    ...
    override fun getGeocodedAddress(address: String): GeocodedAddress? {
        return httpClientAdapter.get("https://maps.googleapis.com/maps/api/geocode/json?address=$address+&key=${mapsProps.apiKey}", null, null, GeocodedAddress::class.java)
    }
